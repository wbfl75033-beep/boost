...
- 설문 화면: `fppartners/index.html` (63문항, Supabase에 응답 저장)
- 테이블/보안 정책 SQL: `supabase/schema.sql`
- 배포: Vercel (`fppartners` 팀 → 프로젝트 이름 `pre-survey`, 이 브랜치에 push하면 자동 재배포)
  → 링크: `https://pre-survey.vercel.app/fppartners`
...
3. `fppartners/index.html`을 정적 호스팅에 배포
